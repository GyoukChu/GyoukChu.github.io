...
title:  "[Review] NCSN"
categories: review
tag: [review, NCSN, Generative Model]
...
denoising score matching은 아래에서 다루고, 여기서 말하는 Langevin dynamics가 결국 backward sampling에 있어 $x_{t-1}=\frac{1}{\sqrt{\alpha_{t}}}(x_{t}-\frac{1-\alpha_{t}}{\sqrt{1-\overline{\alpha_{t}}}}\epsilon_{\theta}(x_{t},t))+\sqrt{\sigma_{t}}z$ 했던, 좀 더 정확히는 $+\sqrt{\sigma_{t}}z$ 했던 행동이 바로 Langevin MCMC를 적용한 것이라 볼 수 있다.
